...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Bettercap-FF0000?style=for-the-badge&logo=linux&logoColor=white"/>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/dlib-008000?style=flat-square&logo=python&logoColor=white"/>
...
### [🦀 VenomStrike](https://github.com/Soulcynics404/VenomStrike)

**Web Vulnerability Scanner & VAPT Reporter**

<p>
  <img src="https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white"/>
  <img src="https://img.shields.io/badge/Tokio-6A0DAD?style=flat-square&logo=rust&logoColor=white"/>
  <img src="https://img.shields.io/badge/NVD_API-CC0000?style=flat-square&logo=databricks&logoColor=white"/>
  <img src="https://img.shields.io/badge/OWASP-000000?style=flat-square&logo=owasp&logoColor=white"/>
</p>

- ⚙️ **5-phase automated pipeline** — recon, fingerprinting, CVE intelligence, active scanning, reporting
- 🔍 **11 custom detection modules** — SQLi, XSS, SSRF, LFI, SSTI, CORS, CSRF, SSL/TLS
- 🌐 Live CVE lookup via **NVD API 2.0, ExploitDB, EPSS scores & CISA KEV catalog**
- 📄 Generates VAPT reports in **4 formats** — HTML, JSON, PDF, SARIF — with exact payload highlighting
- 🛠️ Step-by-step remediation guidance with real CVSS scoring and exploit availability data
...
<h2 align="center">👻 "You can't defend what you don't understand. I understand your attack surface." 👻</h2>
